<template>
	<div class='view-contract-doctor-evaluate'>
		<group class="common-menu-list">
			...
			<cell title="平均星级：">
				<rater v-model="doctorEvaluation.AveStar" active-color="#FF9900" :margin="4" slot='child'></rater>
			</cell>
		</group>
		<scroller ref='scroller' class='common-scroller' :on-refresh="refresh" :on-infinite="infinite">
			...
			<div class="list">
				<group class="common-menu-list">
					<cell v-for='t in list' title="评价星级：" :inline-desc='t.Content' :value='t.AddTime.split(" ")[0]'>
						<rater v-model="t.ServiceStar" active-color="#FF9900" :margin="4" slot='icon'></rater>
					</cell>
				</group>
