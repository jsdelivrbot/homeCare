<template>
	<div class='view-user-edit-data common-padding'>
		...
		<group>
			...
			<x-input title="医院" disabled v-model='userDetails.AgencyName' placeholder="请输入医院名称"></x-input>
			<x-input title="科室" disabled v-model='userDetails.DepartName' placeholder="请输入科室名称"></x-input>
			<x-input title="职称" disabled v-model='userDetails.ClinicalTitle' placeholder="请输入职称"></x-input>
			<x-input title="擅长" disabled v-model='userDetails.GoodAtTreatment' placeholder="请输入擅长项目"></x-input>
			<x-input title="平均星级" disabled v-model='userDetails.ServiceStar' placeholder="请输入擅长项目"></x-input>
			<x-input title="签约用户" disabled v-model='userDetails.SignUserCount'></x-input>
			...
			<!--<x-input class='medical-history' title="个人病史" placeholder="请输入病史" v-model='userDetails.MedicalHistory' disabled @click.native='textareaShow=true'></x-input>-->
		</group>
		<popup v-model="textareaShow">
			<x-textarea v-model='userDetails.MedicalHistory' placeholder="请输入个人病史" :rows='5' :max='100' autosize></x-textarea>
		</popup>	
	</div>
</template>
<script>
