<template>
	<div class='view-track'>
		...
		<dateTime ref='dateTime'
		    @on-change='getData'></dateTime>
		<memberFamily ref='memberFamily'
		    @on-hide='memberFamilyChange'></memberFamily>
	</div>
</template>
  ...
  methods: {
    ...
    mapInit() {
      ...
      var myIcon = new BMap.Icon(
        "http://wxuser.homecare.xuhuicn.com/start-icon.png",
        new BMap.Size(30, 30)
      );
      var myIcon1 = new BMap.Icon(
        "http://wxuser.homecare.xuhuicn.com/end-icon.png",
        new BMap.Size(30, 30)
      );
      var startIcon = new BMap.Marker(
        new BMap.Point(this.pointList[0].lng, this.pointList[0].lat),
        {
          icon: myIcon
        }
      ); // 创建标注
      var stopIcon = new BMap.Marker(
        new BMap.Point(
