<template>
	<div class='view-contract-doctor'>
		<div class="common-header-right">
			<router-link v-show='isSign=="1"&&!$route.query.userId' :to="{path:'/homeRouterView/hospital'}">添加</router-link>
		</div>
				...
				<ul class="clearfix">
					<li v-for='(t,i) in filterList'>
						<router-link :to="{path: '/homeRouterView/contractDoctorDetails',query:{id:t.ID,isSign:isSign,userId:$route.query.userId}}">
							...
							<rater v-model="t.ServiceStar" slot="value" active-color="#FF9900" :margin="4" disabled></rater>
							</h3>
								<p>
