<template>
	<div class='view-real-name common-padding'>
		...
		<div class="content">
			<div class="form" v-if='realState=="-1"||againRealState==true'>
				<div class="title">
					请填写真实个人信息
				</div>
			...
			<div class="state-box">
				...
				<div class="danger" v-if='realState=="2"&&againRealState==false'>
					<div class="img"><img src="~assets/images/real-name-danger.png" /></div>
					<p>您的认证失败，<br />请重新填写认证信息！</p>
					<x-button text='重新认证' type="primary" @click.native='againRealState=true'></x-button>
				</div>
