	...
	<div class='view-user-center'>	
		<div class='content common-padding'>
			<div class="common-user-details">
				<div class="left">
					<spinner v-if='follow.loading' type="ios"></spinner>
				...
				<div class="center">
					<router-link :to="{path:'/userCenterRouterView/editPersonalData'}">
						...
						<h1>{{details.RealName}}<i :class='{active:details.RealState==1}'></i></h1>
						<!--<p>{{$common.sexType[details.Sex]}}&nbsp;&nbsp;&nbsp;&nbsp;岁</p>-->
					</router-link>
				</div>
				<div class="right">
					<spinner v-if='guardian.loading' type="ios"></spinner>
			...
			<div class="instrument">
				...
				<div class="instrument-box" :class='{active:eqiupState}'>
					<i></i> 居家护理仪
			...
			<group class="common-menu-list">
				...
				<cell title="人脸识别" is-link :link="{path:'/userCenterRouterView/faceRecognition',query:{idCard:details.IDCard}}">
					<img src="~assets/images/wd_icon_face.png" slot='icon' />
				</cell>
